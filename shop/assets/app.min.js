/*! ziplines_blank_template - v0.2.0 - */
/*! offline 0.7.2 */
(function() {
    var a, b, c, d, e, f, g;
    d = function(a, b) {
        ...
        }, null === a.onprogress ? (a.addEventListener("error", c, !1), a.addEventListener("timeout", c, !1), 
        a.addEventListener("load", d, !1)) : (e = a.onreadystatechange, a.onreadystatechange = function() {
    ...
    d = Offline.reconnect = {}, f = null, e = function() {
        ...
        d.state = "waiting", b()) : void 0 : void 0;
